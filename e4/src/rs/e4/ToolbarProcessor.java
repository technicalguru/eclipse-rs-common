...
public class ToolbarProcessor {
	...
	protected void addHelpToolItem(MToolBar toolBar, MApplication application) {
		removeCommand(toolBar, "rs.rcpplugins.common.e4.command.help");
		addSeparator(toolBar);
		MCommand command = getCommand(application, "rs.rcpplugins.common.e4.command.help");
		addCommand(toolBar, command, "rs.rcpplugins.common.e4.handledtoolitem.help", "platform:/plugin/rs.rcpplugins.common.e4/resources/icons/question-white.png", Plugin.translate("%e4xmi.menu.help.label"));
	}
